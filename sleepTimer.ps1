<#
    Script Name : sleepTimer.ps1
    Description : Interactive sleep timer utility for Windows system.
...
Clear-Host
Write-Host "============================================"
Write-Host "   Sleep Timer - Choose Delay"
Write-Host "============================================"
Write-Host " [1] Sleep in 2 minutes"
Write-Host " [2] Sleep in 5 minutes"
Write-Host " [3] Sleep in 10 minutes"
Write-Host " [4] Sleep in 30 minutes"
