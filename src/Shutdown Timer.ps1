<#
    Script Name : Shutdown Timer.ps1
    Description : Interactive shutdown timer utility for Windows system.
...
Clear-Host
Write-Host "============================================"
Write-Host "   Shutdown Timer - Choose Delay"
Write-Host "============================================"
Write-Host " [1] Shutdown in 2 minutes"
Write-Host " [2] Shutdown in 5 minutes"
Write-Host " [3] Shutdown in 10 minutes"
Write-Host " [4] Shutdown in 30 minutes"
