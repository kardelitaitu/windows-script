<# 
    Script Name : Hibernate Timer.ps1
    Description : Interactive hibernate timer utility for Windows system.
...
Clear-Host
Write-Host "============================================"
Write-Host "   Hibernate Timer - Choose Delay"
Write-Host "============================================"
Write-Host " [1] Hibernate in 2 minutes"
Write-Host " [2] Hibernate in 5 minutes"
Write-Host " [3] Hibernate in 10 minutes"
Write-Host " [4] Hibernate in 30 minutes"
